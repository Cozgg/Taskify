...
public class DTOMapper {
    ...
    public static ResListDTO toListDTO(List list) {
        if (list == null) return null;
        ResListDTO dto = new ResListDTO();
        dto.setId(list.getId());
        dto.setName(list.getName());
        dto.setPosition(list.getPosition());
        dto.setStatus(list.getStatus() != null ? ListStatus.valueOf(list.getStatus()) : null);
        
        if (list.getCardSet() != null) {
            dto.setCards(list.getCardSet().stream()
    ...
    public static ResBoardDTO toBoardDTO(Board board) {
        ...
        if (board.getListSet() != null) {
            dto.setLists(board.getListSet().stream()
